...
namespace SetVersion.Lib.Tests
{
    public class VersionStringTests
    {
        ...
        [InlineData("1.2.3-pre99", "1", "2", "3", null, "pre99")]
        ...
        [InlineData("1-pre99", "1-pre99", null, null, null, null)]
        [InlineData("1.2-pre99", "1", "2-pre99", null, null, null)]
        // Cases with integers of more than 1 digit.
        [InlineData("10.20.30", "10", "20", "30", null, null)]
        [InlineData("10.20.30.40", "10", "20", "30", "40", null)]
        [InlineData("10.20.30-pre99", "10", "20", "30", null, "pre99")]
        [InlineData("10.20.30.40-pre99", "10", "20", "30", "40", "pre99")]
        // Cases where the suffix includes repeated use of '-'.
        [InlineData("1.2.3-pre99-57", "1", "2", "3", null, "pre99-57")]
        ...
        [InlineData("{{Inc}}", "{{Inc}}", null, null, null, null)]
        [InlineData("1.{{Inc}}", "1", "{{Inc}}", null, null, null)]
        [InlineData("1.2.{{Inc}}", "1", "2", "{{Inc}}", null, null)]
        [InlineData("1.2.3.{{Inc}}", "1", "2", "3", "{{Inc}}", null)]
        ...
        [InlineData("##rel.txt##", "##rel.txt##", null, null, null, null)]
        [InlineData("1.##rel.txt##", "1", "##rel.txt##", null, null, null)]
        [InlineData("##rel.txt##.3", "##rel.txt##", "3", null, null, null)]
        [InlineData("1.##rel.txt##.3", "1", "##rel.txt##", "3", null, null)]
        [InlineData("{{Now:hh.mm}}", "{{Now:hh.mm}}", null, null, null, null)]
        [InlineData("1.{{Now:hh.mm}}", "1", "{{Now:hh.mm}}", null, null, null)]
        [InlineData("{{Now:hh.mm}}.3", "{{Now:hh.mm}}", "3", null, null, null)]
        [InlineData("1.{{Now:hh.mm}}.3", "1", "{{Now:hh.mm}}", "3", null, null)]
        [InlineData("%%Bamboo.BuildNumber%%", "%%Bamboo.BuildNumber%%", null, null, null, null)]
        [InlineData("1.%%Bamboo.BuildNumber%%", "1", "%%Bamboo.BuildNumber%%", null, null, null)]
        [InlineData("%%Bamboo.BuildNumber%%.3", "%%Bamboo.BuildNumber%%", "3", null, null, null)]
        [InlineData("1.%%Bamboo.BuildNumber%%.3", "1", "%%Bamboo.BuildNumber%%", "3", null, null)]
        // Badly closed variables will consume to the end of the string.
        [InlineData("{{Inc}", "{{Inc}", null, null, null, null)]
        [InlineData("{{Inc}.3", "{{Inc}.3", null, null, null, null)]
        [InlineData("1.{{Inc}.3", "1", "{{Inc}.3", null, null, null)]
        ...
        public void Ctor_SetsPropertiesCorrectly(string input, string major, string minor, string revision, string build, string suffix)
        {
